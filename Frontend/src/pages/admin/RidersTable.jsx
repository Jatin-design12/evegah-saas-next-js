      ...
      <div className="flex relative z-10 w-full">
        ...
        <main className="flex-1 w-full min-w-0 overflow-y-auto relative z-10 overflow-x-hidden sm:ml-[var(--admin-sidebar-width,16rem)]">
          <AdminTopbar
            ...
            subtitle="Oversee your rider network and track performance metrics"
          />
            ...
            <div className="mb-8 flex flex-wrap items-start justify-between gap-4">
              <div className="flex flex-wrap items-center justify-end gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-slate-900 text-white text-sm font-semibold shadow-lg hover:opacity-95 disabled:opacity-60"
                  disabled={loading}
                  title="Refresh"
                >
                  <RefreshCw size={16} />
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-blue-600 text-white text-sm font-semibold shadow-lg hover:opacity-95"
                  title="Export CSV"
                >
                  <Download size={16} />
                ...
                <div ref={transferMenuRef} className="relative">
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-emerald-600 text-white text-sm font-semibold shadow-lg hover:opacity-95 disabled:opacity-60"
                ...
                <button
                  type="button"
                  onClick={exportPDF}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-rose-600 text-white text-sm font-semibold shadow-lg hover:opacity-95"
                  title="Export PDF"
                >
                  <FileText size={16} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              {[
                ...
                <div key={label} className="group relative overflow-hidden bg-white/70 backdrop-blur-xl rounded-2xl p-6 shadow-xl border border-white/30 hover:shadow-2xl hover:scale-102 transition-all duration-300 cursor-pointer">
                  ...
                  <div className="absolute top-0 right-0 w-16 h-16 bg-blue-100 rounded-full -translate-y-6 translate-x-6 group-hover:scale-110 transition-transform duration-300"></div>
                  <div className="absolute bottom-0 left-0 w-12 h-12 bg-violet-100 rounded-xl translate-y-3 -translate-x-3 group-hover:rotate-12 transition-transform duration-300"></div>
            ...
            {selected.length > 0 && (
              <div className="mb-6 flex flex-wrap gap-3 bg-white/70 backdrop-blur-xl p-4 rounded-2xl shadow-xl border border-white/30">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-2xl bg-blue-600 text-white text-sm font-semibold shadow-lg hover:opacity-95"
                >
                  Export CSV
                </button>
                <button
                  ...
                  className="px-4 py-2 rounded-2xl bg-red-600 text-white text-sm font-semibold shadow-lg hover:opacity-95"
                >
                  Delete
                </button>
              </div>
